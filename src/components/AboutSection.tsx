      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div data-aos="fade-up" data-aos-delay="600" className="mb-20">
          <div className="text-center mb-8">
            ...
            <div className="flex justify-center">
              <p className="font-crimson text-xl leading-relaxed mb-8 text-white/90 max-w-3xl text-center">
                With over six decades of combined expertise, we have guided clients through
                market cycles, economic changes, and evolving financial needs. From Insurance to Mutual Funds to now Equity, our diverse strengths help clients protect, grow, and diversify wealth.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <div className="premium-card p-6 text-center bg-white/10 rounded-xl" data-aos="zoom-in" data-aos-delay="100">
              <div className="font-playfair text-3xl md:text-4xl font-bold text-secondary mb-2">1500+</div>
              <div className="font-crimson text-lg md:text-xl text-white/80">Clients Served</div>
            </div>
          </div>
        </div>
        ...
        <div data-aos="fade-up" data-aos-delay="700" className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="premium-card p-6 bg-white/10 rounded-xl shadow-floating text-center" data-aos="fade-right">
              ...
              <p className="font-crimson text-lg text-white/80 text-justify">
            ...
            <div className="premium-card p-6 bg-white/10 rounded-xl shadow-floating text-center" data-aos="fade-left">
              ...
              <p className="font-crimson text-lg text-white/80 text-justify">
                To provide holistic financial solutions that help individuals and clients
        ...
        <div data-aos="fade-up" data-aos-delay="800">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="font-crimson text-lg leading-relaxed mb-8 text-white/90 text-justify">
              ...
              the rewards of our grandfather's hard work, and more importantly, carrying forward
